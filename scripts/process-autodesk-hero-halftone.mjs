#!/usr/bin/env node
/**
 * Bake halftone into Autodesk hero PNG (Tier-A parity with Wipro/EY pipeline).
 *
 * Cloned from `scripts/process-wipro-hero-halftone.mjs`. Same Bayer 8×8 ordered
 * dither, identical parameters — DO NOT retune. Source/output paths only.
 *
 * Run from repo root:
 *   node scripts/process-autodesk-hero-halftone.mjs
 */
