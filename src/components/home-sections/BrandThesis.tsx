...
import { StanfordAICapabilityEmbedded } from "./StanfordAICapability";
...
export function BrandThesis() {
  return (
    <Section className="relative overflow-hidden border-t border-ink-200/55 bg-base-100 py-section">
      ...
      />
      {/* Thesis + portrait: two columns. Stanford spans full section width below. */}
      <div className="relative z-10 space-y-10 lg:space-y-12">
        <div className="grid gap-8 sm:gap-10 lg:grid-cols-[1fr,minmax(0,1.2fr)] lg:items-start lg:gap-12">
          ...
          <div className="min-h-[180px] w-full max-w-xl lg:max-w-none">
        ...
        <div className="w-full border-t border-ink-200/55 pt-10">
          <StanfordAICapabilityEmbedded />
        </div>
      </div>
    </Section>
  );
