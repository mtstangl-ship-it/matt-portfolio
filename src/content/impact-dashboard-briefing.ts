...
export const impactBriefingIdentity = {
  kicker: "— Live Impact Briefing · Q1 2026",
  headline: "Enterprise design, ",
  headlineMuted: "measured at altitude.",
  sub:
  ...
  card: [
    ...
    { k: "Window", v: "0→1 practice builds · 1→2 experience delivery" },
  ],
} as const;
...
export const impactCaseOps = {
  ...
  roleTrail:
    " for Estée Lauder and Takeda — building the frameworks, metrics, and delivery model that improved NPS past goal and secured an eight-figure renewal.",
  hero: { kind: "plain" as const, em: "15", suffix: "%+" },
  heroLbl: "NPS goal exceeded",
  heroUnit: "Eight-figure renewal secured",
  metrics: [
    { v: "16,000", vSmall: "+", k: "Cases routed" },
    { v: "30", vSmall: "+", k: "Outcomes shipped" },
    { v: "3", vSmall: "", k: "Handoff tiers" },
    { v: "+15", vSmall: "%", k: "NPS over goal" },
  ],
  ...
  deltaLeft: "Delta across 16k cases",
...
export const impactCaseHealth = {
  ...
  heroUnit: "Across 4 cities · 10+ partners",
  metrics: [
    { v: "4.57", vSmall: "M", k: "Engagements" },
    { v: "715", vSmall: "", k: "Vaccinations" },
    { v: "10", vSmall: "+", k: "Delivery partners" },
    { v: "4", vSmall: "", k: "City hubs" },
  ],
  ...
  cities: [
    {
      ...
      num: "2.41M",
      numSmall: "engagements · 412 vaccines",
      cx: 70,
      cy: 96,
      r: 10,
      label: "ATLANTA",
    ...
    },
    {
      ...
      idLabel: "02",
      name: "Augusta",
      small: "Regional health system · rural reach",
      num: "0.94M",
      numSmall: "engagements · 168 vaccines",
      cx: 229.6,
      cy: 121.6,
      r: 7.5,
      label: "AUGUSTA",
    ...
    },
    {
      ...
      idLabel: "03",
      name: "Macon",
      small: "Community pathway pilot",
      num: "0.71M",
      numSmall: "engagements · 89 vaccines",
      cx: 140,
      cy: 176,
      r: 7,
      label: "MACON",
    ...
    },
    {
      ...
      num: "0.51M",
      numSmall: "engagements · 46 vaccines",
      cx: 246,
      cy: 224,
      r: 6.5,
      label: "SAVANNAH",
  ...
  partners: [
    { b: "715", rest: " vaccines administered" },
    { b: "4.57M", rest: " engagements" },
    { b: "10+", rest: " partners" },
  ],
};
