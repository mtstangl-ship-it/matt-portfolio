...
export function GarageLayout() {
  return (
    <svg
      ...
      viewBox="0 0 320 220"
      aria-label="Two-bay garage layout: Alice and Ayda parked, workbench at rear"
      xmlns="http://www.w3.org/2000/svg"
    >
      <g fill="none" stroke="var(--ink-line)" strokeWidth="1">
        <rect x="10" y="10" width="300" height="200" />
        <rect x="30" y="24" width="260" height="22" />
        <line x1="30" y1="35" x2="290" y2="35" strokeDasharray="2 3" strokeWidth="0.5" />
        <line x1="160" y1="60" x2="160" y2="200" strokeDasharray="3 4" strokeWidth="0.5" />
        <line x1="10" y1="200" x2="310" y2="200" strokeWidth="2" />
        <g strokeWidth="0.4">
          <line x1="40" y1="196" x2="40" y2="204" />
          <line x1="80" y1="196" x2="80" y2="204" />
          <line x1="120" y1="196" x2="120" y2="204" />
          <line x1="200" y1="196" x2="200" y2="204" />
          <line x1="240" y1="196" x2="240" y2="204" />
          <line x1="280" y1="196" x2="280" y2="204" />
        </g>
      </g>

      <g transform="translate(85 130)">
        <circle cx="-22" cy="0" r="10" fill="none" stroke="var(--accent)" strokeWidth="1" />
        <circle cx="22" cy="0" r="10" fill="none" stroke="var(--accent)" strokeWidth="1" />
        <line x1="-22" y1="0" x2="22" y2="0" stroke="var(--accent)" strokeWidth="1.5" />
        <rect x="-6" y="-8" width="12" height="6" fill="var(--accent)" stroke="none" />
      </g>
      <text x="85" y="168" fontFamily="ui-monospace, monospace" fontSize="9" letterSpacing="1.5" fill="var(--ink-2)" textAnchor="middle">
        ALICE
      </text>
      <text x="85" y="182" fontFamily="ui-monospace, monospace" fontSize="7" letterSpacing="1.2" fill="var(--ink-3)" textAnchor="middle">
        &apos;78 R100/7
      </text>
      <text x="30" y="66" fontFamily="ui-monospace, monospace" fontSize="8" letterSpacing="1.5" fill="var(--ink-3)">
        BAY A
      </text>
      ...
      <text x="235" y="168" fontFamily="ui-monospace, monospace" fontSize="9" letterSpacing="1.5" fill="var(--ink-2)" textAnchor="middle">
        AYDA
      </text>
      <text x="235" y="182" fontFamily="ui-monospace, monospace" fontSize="7" letterSpacing="1.2" fill="var(--ink-3)" textAnchor="middle">
        &apos;77 R75/7
      </text>
      <text x="180" y="66" fontFamily="ui-monospace, monospace" fontSize="8" letterSpacing="1.5" fill="var(--ink-3)">
        BAY B
      </text>

      <text x="160" y="19" fontFamily="ui-monospace, monospace" fontSize="7" letterSpacing="1.5" fill="var(--ink-3)" textAnchor="middle">
        WORKBENCH
      </text>
      <text x="160" y="217" fontFamily="ui-monospace, monospace" fontSize="7" letterSpacing="1.5" fill="var(--ink-3)" textAnchor="middle">
        DOOR — OUTSIDE
      </text>
    </svg>
  );
